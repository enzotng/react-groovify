    ...
    <div className="dashboard-wrapper">
      ...
      <div className="profile-settings">
        <ul>
          ...
          <h2>Video Quality</h2>
          <li className="wifi-streaming">
            <Link to="wifi-streaming">
              Wi-Fi Streaming<span>Very High</span>
            </Link>
          </li>
          <li className="data-cellular">
            <Link to="data-cellular">
              Data Cellular<span>Automatic</span>
            </Link>
          </li>
        </ul>
        <div className="dark-mode-switch">
          <span className="darkmode">Auto Adjust Quality</span>
